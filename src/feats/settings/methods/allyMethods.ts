...
export const setLinkHighlight = ({
	...
	// const setLinkStyle = () => {
	// 	return Boolean(step ?? settingsState?.activeStep) ?
	// 		"link.style.backgroundColor = 'yellow'; link.style.color = 'black';"
	// 		: "link.style.backgroundColor = ''; link.style.color = '';";
	// }
	//
	// const applyHighlightStyle = `
	// const links = document.querySelectorAll('a');
	// links.forEach((link) => '${setLinkStyle()}');
	// `;
	//
	// ref.current?.injectJavaScript(applyHighlightStyle);
